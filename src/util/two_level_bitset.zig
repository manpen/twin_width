...
pub const FastBitSet = struct {
    ...
    pub inline fn initEmpty(size: u32, allocator: std.mem.Allocator) !Self {
        ...
        return Self{ .storage = storage, .storage_higher = storage_higher, .cardinality = 0, .total_len = size };
    }
    ...
    pub inline fn initFull(size: u32, allocator: std.mem.Allocator) !Self {
        ...
        return Self{ .storage = storage, .storage_higher = storage_higher, .cardinality = size, .total_len = size };
    }
    ...
    pub inline fn copy(self: *const Self, allocator: std.mem.Allocator) !Self {
        ...
        return Self{ .allocator = allocator, .storage = storage, .storage_higher = storage_higher, .cardinality = self.cardinality, .total_len = self.total_len };
    }
